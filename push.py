...
def push_prototypes(dataloader, # pytorch dataloader (must be unnormalized in [0,1])
    ...
    saved_prototypes = get_overlayed_prototypes(n_prototypes,dir_for_saving_prototypes=proto_epoch_dir,prototype_img_filename_prefix=prototype_img_filename_prefix)
    prototype_images_path = get_prototype_images(n_prototypes,dir_for_saving_prototypes=proto_epoch_dir,prototype_img_filename_prefix=prototype_img_filename_prefix)
    ...
    return saved_prototypes, prototype_images_path
...
def get_overlayed_prototypes(n_prototypes,dir_for_saving_prototypes=None,prototype_img_filename_prefix=None):
    prototype_images_path = []
    for j in range(n_prototypes):
        prototype_images_path.append(os.path.join(dir_for_saving_prototypes,
                                            prototype_img_filename_prefix + '-original_with_self_act' + str(j) + '.png'))
    return prototype_images_path


def get_prototype_images(n_prototypes,dir_for_saving_prototypes=None,prototype_img_filename_prefix=None):
    prototype_images_path = []
    for j in range(n_prototypes):
        prototype_images_path.append(os.path.join(dir_for_saving_prototypes,
                                            prototype_img_filename_prefix + '-original' + str(j) + '.png'))
